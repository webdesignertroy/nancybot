...
module.exports = function(robot) {
    ...
    robot.respond(/Nancy?/i, function(hello) {
        return hello.send('Hello, I can help you stay healthy. Please enter your weight and height in this format. Weight: xx Foot: xx Inch: xx.');
    })
